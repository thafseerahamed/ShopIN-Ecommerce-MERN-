          ...
          <Fragment>
                  ...
                  <div className="cart-item" key={item.product}>
                    <div className="row">
                      ...
                      <div className="col-4 col-lg-1 mt-4 mt-lg-0">
                        <i
                          id="delete_cart_item"
                          className="fa fa-trash btn btn-danger" onClick={() => removeCartItemHandler(item.product,item.name)}
                        ></i>
                      </div>
                    </div>
                  </div>
            ...
            <div className="col-12 col-lg-3 my-4">
              <div id="order_summary">
                ...
                <p>
                  Est. total: <span className="order-summary-values">₹{cartItems.reduce((acc,item) => (acc+ Number(item.quantity*item.price)),0 ).toFixed(2)}</span>
                </p>
